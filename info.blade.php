...
<div class="container">
    <div class="jumbotron">
        ...
        <p>接口地址：<b id="link">{{ isset($doc['url']) ? $doc['url'] : '请设置url注释' }}</b> <span class="label label-success">{{ isset($doc['method']) ? $doc['method'] : 'GET' }}</span> <button type="button" onclick="copyToClipboard('#link')" class="btn btn-success">Copy</button></p>
